...
object TreeBrownPalette {
    ...
    private val lightTheme = ThemeDefinition(
        id = ThemeId("tree_brown_light"),
        displayName = "Tree Brown Light",
    ...
    private val darkTheme = ThemeDefinition(
        id = ThemeId("tree_brown_dark"),
        displayName = "Tree Brown Dark",
    ...
    const val FAMILY_ID = "tree_brown"
    val treeBrownFamily = ThemeFamily(
        id = ThemeId(FAMILY_ID),
        displayName = "Tree Brown",
        light = lightTheme,
        dark = darkTheme
    )
}