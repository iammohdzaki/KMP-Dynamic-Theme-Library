...
object LeafGreenPalette {
    ...
    private val lightTheme = ThemeDefinition(
        id = ThemeId("leaf_green_light"),
        displayName = "Leaf Green Light",
    ...
    private val darkTheme = ThemeDefinition(
        id = ThemeId("leaf_green_dark"),
        displayName = "Leaf Green Dark",
    ...
    const val FAMILY_ID = "leaf_green"
    val leafGreenFamily = ThemeFamily(
